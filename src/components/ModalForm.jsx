    ...
    <section className={`modalForm ${isShowModal ? "activeForm" : ""}`}>
      <form onSubmit={handleSubmit(submit)} className='modalForm__form'>
        ...
        <div className='modalForm__div'>
          <label className='modalForm__label' htmlFor=""><i className='bx bx-user'></i> First Name</label>
        ...
        <div className='modalForm__div'>
          <label className='modalForm__label' htmlFor=""><i className='bx bx-mail-send'></i> Email</label>
          <input className='modalForm__input' type="email" {...register("email")} />
        </div>
        <div className='modalForm__div'>
          <label className='modalForm__label' htmlFor=""><i className='bx bx-lock'></i> Password</label>
          <input className='modalForm__input' type="password" {...register("password")} />
        </div>
        <div className='modalForm__div'>
          <label className='modalForm__label' htmlFor=""><i className='bx bx-cake' ></i> Birthday</label>
